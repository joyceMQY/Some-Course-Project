...
def test():
    ...
    rfY = rfTest[:,-1]
    writer = csv.writer(open('YpreP.csv', 'wb'), delimiter=',')
    ...
    writer = csv.writer(open('YpreC.csv', 'wb'), delimiter=',')
    for i in range(0,rfY.shape[0]):
    ...
    writer = csv.writer(open('rrr.csv', 'wb'), delimiter=',')
    row_to_enter = ['rms', rfRMS]
    writer.writerow(row_to_enter)
    row_to_enter = ['corr', rfCorr]
    writer.writerow(row_to_enter)

    writer = csv.writer(open('firstDate.csv', 'wb'), delimiter=',')
    for i in range(0,100):
        row_to_enter = [firstDate[i]]
        writer.writerow(row_to_enter)

    writer = csv.writer(open('lastDate.csv', 'wb'), delimiter=',')
    for i in range(0,100):
        row_to_enter = [lastDate[i]]
        writer.writerow(row_to_enter)

    writer = csv.writer(open('features.csv', 'wb'), delimiter=',')
    for i in range(0,100):
    ...
    createComparison5Plot('Dates', 'Values', firstDate, firstX1, firstX2, firstX3, firstX4, firstX5, 'first100Features.pdf', linename)
